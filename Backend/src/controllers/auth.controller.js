...
const logoutUser = asyncHandler(async (req, res) => {
  ...
  return res.status(200).json(new ApiResponse(200, {}, "User LogedOUt"));
});
...
const resendEmailVerification = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, {}, "Email has been sent to your account"));
});
...
const forgotPasswordRequest = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(
      new ApiResponse(200, {}, "Passwrd Reset mail has been sent successfully"),
    );
});
...
const resetForgotPassword = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, {}, "New Password reset successfully"));
});
...
const changeCurrentPassword = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, {}, "Password has been changed succesfully."));
});
